...
data_transforms = {
    'Train': transforms.Compose([
        transforms.Resize(333),  # Resize images to 333x333
        transforms.RandomResizedCrop(224),  # Randomly crop images to 299x299
    ...
    'Validation': transforms.Compose([
        ...
        transforms.CenterCrop(224),  # Center crop images to 299x299
        transforms.ToTensor(),
